...
![Fig 1](https://github.com/shohirose/qiita-articles/blob/main/images/fractional_flow_equation.png)
...
![Fig 2](https://github.com/shohirose/qiita-articles/blob/main/images/fractional_flow_solution.png)
...
![Fig 3](https://github.com/shohirose/qiita-articles/blob/main/images/shock_front_saturation.png)

Shock frontの左側は連続なので、式(18)またはBuckley-Reverett equationに従って飽和率が計算されます。よって最終的に式(18)の解は下図のsolutionの線となります。

![Fig 4](https://github.com/shohirose/qiita-articles/blob/main/images/fractional_flow_solution.png)